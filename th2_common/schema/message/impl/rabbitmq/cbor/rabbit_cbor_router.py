...
from th2_common.schema.message.impl.rabbitmq.cbor.rabbit_cbor_sender import RabbitCborSender
from th2_common.schema.message.impl.rabbitmq.cbor.rabbit_cbor_subscriber import RabbitCborSubscriber
...
class RabbitCborRouter(AbstractRabbitMessageRouter):
    ...
    def required_subscribe_attributes(self):
        return {QueueAttribute.SUBSCRIBE.value, QueueAttribute.CBOR.value}

    @property
    def required_send_attributes(self):
        return {QueueAttribute.PUBLISH.value, QueueAttribute.CBOR.value}

    def create_sender(self, connection_manager: ConnectionManager,
                      queue_configuration: QueueConfiguration, th2_pin) -> MessageSender:
        return RabbitCborSender(connection_manager, queue_configuration.exchange,
    ...
    def create_subscriber(self, connection_manager: ConnectionManager,
        ...
        return RabbitCborSubscriber(connection_manager,
                                                 queue_configuration,
