...
from th2_grpc_common.common_pb2 import AnyMessage, ByteMessage, ConnectionID, Direction, EventID, ListValue, \
    Message, MessageID, MessageMetadata, RawMessage, RawMessageMetadata, Value
...
#  AnyMessage.byte_message

byte_message = ByteMessage(parent_event_id=parent_event_id,
                           metadata=RawMessageMetadata(
                               id=MessageID(
                                   connection_id=ConnectionID(session_alias='jsTUURfy'),
                                   direction=Direction.SECOND
...
any_message_byte = AnyMessage(byte_message=byte_message)
