...
from th2_grpc_common.common_pb2 import AnyMessage, ByteMessage, ConnectionID, Direction, Message, MessageGroup, \
...
message_group5 = MessageGroup(messages=[  # goes to queue_OR_AND_filter
    AnyMessage(  # to QUEUE3 (OR-AND filter)
...
message_group6 = MessageGroup(messages=[  # goes to queue_EMPTY_filter
...
filtered_by_queue = {
    ...
    'queue_OR_AND_filter': MessageGroupBatch(
        groups=[message_group2, message_group3, message_group4, message_group5]),
    'queue_EMPTY_filter': MessageGroupBatch(
        groups=[message_group1, message_group2, message_group3, message_group4, message_group5, message_group6])
}
