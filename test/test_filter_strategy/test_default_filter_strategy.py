...
from test.test_filter_strategy.resources.messages_for_extraction import any_message, any_message_byte, \
    any_message_raw, byte_message_dict, message_dict, raw_message_dict
...
def test_byte_message_field_extraction() -> None:
    extract_strategy = Th2MsgFieldExtraction()
    assert extract_strategy.get_fields(any_message_byte) == byte_message_dict
