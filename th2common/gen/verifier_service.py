...
class VerifierService(object):
    ...
    def createCheckpoint(self, request):
        return self.connector.createRequest("createCheckpoint",request)

    def submitCheckRule(self, request):
        return self.connector.createRequest("submitCheckRule",request)

    def submitCheckSequenceRule(self, request):
        return self.connector.createRequest("submitCheckSequenceRule",request)
