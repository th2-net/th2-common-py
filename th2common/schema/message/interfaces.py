...
class MessageRouter(ABC):
    ...
    @abstractmethod
    def subscribe(self, callback: MessageListener, queue_alias=None, *queue_attr) -> SubscriberMonitor:
        """
        RabbitMQ queue by intersection schemas queues attributes or queue_alias
