...
from grpc_common.common_pb2 import Direction, Message

from th2common.schema.strategy.field_extraction.field_extraction_strategy import FieldExtractionStrategy
